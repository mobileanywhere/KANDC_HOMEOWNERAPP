...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$selectedPropertyNameAtom =
      Atom(name: '_AppStore.selectedPropertyName', context: context);

  @override
  String get selectedPropertyName {
    _$selectedPropertyNameAtom.reportRead();
    return super.selectedPropertyName;
  }

  @override
  set selectedPropertyName(String value) {
    _$selectedPropertyNameAtom.reportWrite(value, super.selectedPropertyName,
        () {
      super.selectedPropertyName = value;
    });
  }

  late final _$selectedPropertyAddressAtom =
      Atom(name: '_AppStore.selectedPropertyAddress', context: context);

  @override
  String get selectedPropertyAddress {
    _$selectedPropertyAddressAtom.reportRead();
    return super.selectedPropertyAddress;
  }

  @override
  set selectedPropertyAddress(String value) {
    _$selectedPropertyAddressAtom
        .reportWrite(value, super.selectedPropertyAddress, () {
      super.selectedPropertyAddress = value;
    });
  }

  late final _$selectedPropertyAddressIdAtom =
      Atom(name: '_AppStore.selectedPropertyAddressId', context: context);

  @override
  String get selectedPropertyAddressId {
    _$selectedPropertyAddressIdAtom.reportRead();
    return super.selectedPropertyAddressId;
  }

  @override
  set selectedPropertyAddressId(String value) {
    _$selectedPropertyAddressIdAtom
        .reportWrite(value, super.selectedPropertyAddressId, () {
      super.selectedPropertyAddressId = value;
    });
  }

  late final _$setSelectedPropertyNameAsyncAction =
      AsyncAction('_AppStore.setSelectedPropertyName', context: context);

  @override
  Future<void> setSelectedPropertyName(String val,
      {bool isInitializing = false}) {
    return _$setSelectedPropertyNameAsyncAction.run(() =>
        super.setSelectedPropertyName(val, isInitializing: isInitializing));
  }

  late final _$setSelectedPropertyAddressAsyncAction =
      AsyncAction('_AppStore.setSelectedPropertyAddress', context: context);

  @override
  Future<void> setSelectedPropertyAddress(String val,
      {bool isInitializing = false}) {
    return _$setSelectedPropertyAddressAsyncAction.run(() =>
        super.setSelectedPropertyAddress(val, isInitializing: isInitializing));
  }

  late final _$setSelectedPropertyAddressIdAsyncAction =
      AsyncAction('_AppStore.setSelectedPropertyAddressId', context: context);

  @override
  Future<void> setSelectedPropertyAddressId(String val,
      {bool isInitializing = false}) {
    return _$setSelectedPropertyAddressIdAsyncAction.run(() => super
        .setSelectedPropertyAddressId(val, isInitializing: isInitializing));
  }
...
selectedPropertyAddressId: ${selectedPropertyAddressId},
