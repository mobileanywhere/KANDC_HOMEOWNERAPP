...
import 'package:homeowner/screens/about_screen.dart';
import 'package:homeowner/screens/auth/change_password_screen.dart';
import 'package:homeowner/screens/auth/edit_profile_screen.dart';
import 'package:homeowner/screens/auth/property_screen.dart';
import 'package:homeowner/screens/auth/sign_in_screen.dart';
import 'package:homeowner/screens/blog/view/blog_list_screen.dart';
import 'package:homeowner/screens/dashboard/customer_rating_screen.dart';
import 'package:homeowner/screens/dashboard/dashboard_screen.dart';
import 'package:homeowner/screens/service/favourite_service_screen.dart';
import 'package:homeowner/screens/setting_screen.dart';
import 'package:homeowner/screens/subscriptions_screen.dart';
import 'package:homeowner/screens/wallet/user_wallet_balance_screen.dart';
                    ...
                    return SettingSection(
                      ...
                      items: [
                        ...
                        if (isLoginTypeUser)
                          SettingItemWidget(
                            leading:
                                ic_location.iconImage(size: SETTING_ICON_SIZE),
                            title: 'Property',
                            trailing: trailing,
                            onTap: () {
                              doIfLoggedIn(context, () {
                                PropertyScreen().launch(context);
                              });
                            },
                          ),
                        if (isLoginTypeUser)
                        ...
                        Visibility(
                          ...
                          child: SettingItemWidget(
                            ...
                            onTap: () async {
                              ...
                              //     commonLaunchUrl(getStringAsync(PLAY_STORE_URL),
                    ...
                    items: [
                      ...
                      if (appStore.isLoggedIn)
                        SettingItemWidget(
                          ...
                          title: language.lblSubscriptions,
                          onTap: () {
                            SubscriptionsScreen().launch(context);
                          },
                        ),
                      SettingItemWidget(
