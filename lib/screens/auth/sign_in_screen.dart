...
import 'package:homeowner/screens/auth/forgot_password_screen.dart';
import 'package:homeowner/screens/auth/otp_login_screen.dart';
import 'package:homeowner/screens/auth/property_screen.dart';
import 'package:homeowner/screens/auth/sign_up_screen.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  void init() async {
    ...
    if (isRemember) {
      ...
      passwordCont.text = getStringAsync(
        USER_PASSWORD,
  ...
  void _handleLoginUsers() async {
    ...
    await loginCurrentUsers(context, req: request)
        .then((value) async {
          if (isRemember) {
  ...
  void onLoginSuccessRedirection() async {
    if (appStore.userId != null) {
      setState(() {});
      await Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => PropertyScreen(isFromLogin: true),
        ),
      );
    }
