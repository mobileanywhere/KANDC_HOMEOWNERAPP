  ...
  Future<void> sendMessages() async {
    ...
    await chatServices.addMessage(data).then((value) async {
      ...
      if (isReceiverOnline != 1) {
        /// Send Notification
        NotificationService()
            .sendPushNotifications(appStore.userFullName, data.message.validate(), uid: senderUser.uid.validate(), email: senderUser.email.validate(), receiverPlayerId: widget.receiverUser.playerId.validate())
            .catchError((e) {
