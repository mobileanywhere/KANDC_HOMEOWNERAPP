...
import 'package:homeowner/locale/app_localizations.dart';
import 'package:homeowner/locale/language_en.dart';
import 'package:homeowner/locale/languages.dart';
...
import 'package:homeowner/model/material_you_model.dart';
...
import 'package:homeowner/screens/blog/model/blog_detail_response.dart';
import 'package:homeowner/screens/blog/model/blog_response_model.dart';
import 'package:homeowner/screens/splash_screen.dart';
import 'package:homeowner/services/auth_services.dart';
import 'package:homeowner/services/chat_services.dart';
import 'package:homeowner/services/stripe_service_singleton.dart';
import 'package:homeowner/services/user_services.dart';
import 'package:homeowner/store/app_store.dart';
...
void main() async {
  ...
  if (appStore.isLoggedIn) {
    ...
    await appStore.setSelectedPropertyName(
        getStringAsync(SELECTED_PROPERTY_NAME),
        isInitializing: true);
    await appStore.setSelectedPropertyAddress(
        getStringAsync(SELECTED_PROPERTY_ADDRESS),
        isInitializing: true);
    await appStore.setSelectedPropertyAddressId(
        getStringAsync(SELECTED_PROPERTY_ADDRESS_ID),
        isInitializing: true);
  }
